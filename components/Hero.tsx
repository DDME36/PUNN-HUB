            ...
            <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
                ...
                >
                    ...
                    <button
                        ...
                        className="px-8 py-4 bg-white/90 backdrop-blur-md text-gray-700 rounded-2xl font-semibold shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] transition-all border border-white/60 hover:-translate-y-1"
                    >
                        ดูโปรเจกต์
                    </button>
                </motion.div>
