...
export const Hero = () => {
  ...
  return (
    <section className="relative flex min-h-[40vh] items-center justify-center overflow-hidden bg-gradient-to-br from-rose-50/50 via-purple-50/50 to-blue-50/50 py-16 sm:min-h-[50vh] sm:py-24">
      {/* Soft Floating Orbs */}
