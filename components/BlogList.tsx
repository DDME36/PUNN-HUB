                  ...
                  >
                    <Link href={`/blog/${post.slug}`}>
                      <motion.div
                        ...
                        className="group flex h-full cursor-pointer flex-col overflow-hidden rounded-2xl border border-white/60 bg-white/90 shadow-[0_4px_20px_rgb(0,0,0,0.04)] backdrop-blur-xl transition-all duration-300 hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)]"
                      >
                        ...
                        <div className="relative z-10 flex flex-1 flex-col p-6 pt-2 sm:p-8 sm:pt-4">
                          ...
                          {/* Title */}
                          <h2 className="mb-4 line-clamp-2 font-display text-lg font-bold leading-snug text-gray-800 transition-colors group-hover:text-rose-500 sm:text-xl">
                            {post.title}
                          </h2>
