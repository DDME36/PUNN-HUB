          ...
          >
            ...
            <div className="border-t border-gray-100 p-6">
              <motion.a
                ...
                target="_blank"
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-rose-400 to-purple-400 py-4 text-center font-semibold text-white shadow-lg transition-all hover:shadow-xl"
              >
      ...
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            ...
            className="fixed bottom-8 right-8 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-rose-400 to-purple-400 text-white shadow-[0_8px_30px_rgb(251,113,133,0.3)] transition-all hover:shadow-[0_12px_40px_rgb(251,113,133,0.4)]"
          >
            <ChevronUp size={24} />
          </motion.button>
        )}
