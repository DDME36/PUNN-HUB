...
export const Card = ({
  ...
  return (
    <Component
      ...
      className={cn(
        'group relative flex cursor-pointer flex-col overflow-hidden rounded-2xl border border-gray-100/50 bg-white p-4 text-left shadow-[0_4px_20px_rgb(0,0,0,0.04)] transition-all duration-300 hover:shadow-[0_12px_40px_rgb(0,0,0,0.12)] sm:rounded-3xl sm:p-6',
        className
      )}
    >
