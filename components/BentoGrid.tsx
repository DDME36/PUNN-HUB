    ...
    <>
      <div className="mx-auto grid max-w-6xl auto-rows-[160px] grid-cols-1 gap-4 px-4 py-12 sm:auto-rows-[180px] sm:grid-cols-2 md:grid-cols-4 md:gap-5 lg:gap-6">
        ...
        <Card
          ...
          BgIcon={TrendingUp}
          className="group relative col-span-1 row-span-2 overflow-hidden !border-none !bg-gradient-to-br from-emerald-500 to-teal-600 !text-white shadow-[0_8px_30px_rgba(16,185,129,0.25)] sm:col-span-2 md:col-span-2 lg:col-span-2"
          delay={0.1}
          glowColor="rgba(255,255,255,0.2)"
        >
          {/* Shimmer Effect */}
          <div className="absolute inset-0 -translate-x-full animate-[shimmer_2.5s_infinite] bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
        ...
        {/* About Section */}
        <Card
          className="group relative col-span-1 row-span-1 overflow-hidden !border-none !bg-gradient-to-r from-rose-400 via-purple-500 to-indigo-500 !text-white transition-all duration-300 hover:shadow-xl sm:col-span-2 md:col-span-2 lg:col-span-2"
          delay={0.5}
        >
          {/* Shimmer Effect */}
          <div className="absolute inset-0 -translate-x-full animate-[shimmer_3s_infinite] bg-gradient-to-r from-transparent via-white/10 to-transparent delay-500"></div>
