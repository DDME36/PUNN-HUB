  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-20 left-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-purple-400 to-blue-400 text-white shadow-lg lg:hidden"
      >
      ...
      >
        <div className="max-h-[calc(100vh-200px)] max-w-xs overflow-y-auto rounded-2xl border border-gray-200 bg-white/90 p-6 shadow-xl backdrop-blur-xl">
