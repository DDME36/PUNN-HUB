...
**หมายเหตุสำคัญ:** Notion API ไม่รองรับการดึงข้อมูลขนาดรูปที่คุณปรับด้วยการลากมุมรูปใน Notion UI ดังนั้นรูปทั้งหมดจะแสดงที่ขนาดเริ่มต้น 75% ของความกว้างเนื้อหา (ประมาณ 640px บนเดสก์ท็อป)

**วิธีกำหนดขนาดรูปเอง (ถ้าต้องการ):**

- เพิ่ม caption ให้รูปใน Notion ด้วยรูปแบบ `[width:50]` หรือ `[w:50]`
- ตัวเลขคือเปอร์เซ็นต์ (0-100)
- ตัวอย่าง:
  - `[width:25]` = รูปเล็กมาก (320px)
  - `[width:50]` = รูปขนาดกลาง (640px)
  - `[width:75]` = รูปขนาดใหญ่ (800px) - ค่าเริ่มต้น
  - `[width:100]` = รูปขนาดใหญ่สุด (960px)
